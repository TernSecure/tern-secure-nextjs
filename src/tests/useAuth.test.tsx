...
describe('useAuth hook', () => {
  ...
  beforeEach(() => {
    (TernSecureAuth.signIn as jest.Mock).mockImplementation(mockSignIn);
    (TernSecureAuth.signUp as jest.Mock).mockImplementation(mockSignUp);
    (TernSecureAuth.logout as jest.Mock).mockImplementation(mockLogout);
