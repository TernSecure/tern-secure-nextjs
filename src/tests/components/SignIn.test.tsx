...
describe('SignIn Component', () => {
  ...
  test('handles successful sign in with redirect', async () => {
    ...
    (TernSecureAuth.signIn as jest.Mock).mockResolvedValueOnce({
      user: mockUser,
      idToken: mockIdToken
    });
  ...
  test('handles sign in error', async () => {
    ...
    // Mock failed sign in
    (TernSecureAuth.signIn as jest.Mock).mockRejectedValueOnce(new Error(errorMessage));
  ...
  test('shows loading state during submission', async () => {
    // Mock slow sign in
    (TernSecureAuth.signIn as jest.Mock).mockImplementationOnce(
