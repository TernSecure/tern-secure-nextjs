...
describe('SignUp Component', () => {
  ...
  test('handles successful sign up with redirect', async () => {
    ...
    (TernSecureAuth.signUp as jest.Mock).mockResolvedValueOnce(mockUser);
  ...
  test('handles sign up error', async () => {
    ...
    // Mock failed sign up
    (TernSecureAuth.signUp as jest.Mock).mockRejectedValueOnce(new Error(errorMessage));
  ...
  test('shows loading state during submission', async () => {
    // Mock slow sign up
    (TernSecureAuth.signUp as jest.Mock).mockImplementationOnce(
